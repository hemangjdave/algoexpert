...
import static com.techrevolution.algorithms.easy.bubblesort.Solution1.bubbleSort;
...
class Solution1Test {
    ...
    void testSelectionSort1() {
        assertArrayEquals(new int[]{2, 3, 5, 5, 6, 8, 9}, bubbleSort(new int[]{8, 5, 2, 9, 5, 6, 3}));
    }

    @Test
    void testSelectionSort2() {
        assertArrayEquals(new int[]{1}, bubbleSort(new int[]{1}));
        assertArrayEquals(new int[]{1, 2}, bubbleSort(new int[]{1, 2}));
        assertArrayEquals(new int[]{1, 2}, bubbleSort(new int[]{2, 1}));
        assertArrayEquals(new int[]{1, 2, 3}, bubbleSort(new int[]{1, 3, 2}));
        assertArrayEquals(new int[]{1, 2, 3}, bubbleSort(new int[]{3, 1, 2}));
    }
    ...
    void testSelectionSort3() {
        assertArrayEquals(
                ...
                bubbleSort(new int[]{-4, 5, 10, 8, -10, -6, -4, -2, -5, 3, 5, -4, -5, -1, 1, 6, -7, -6, -7, 8})
        );
    }
